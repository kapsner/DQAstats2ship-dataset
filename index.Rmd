---
title: "Analyze SHIP dataset with DQAstats"
...
First of all, all required R packages need to be installed.
...
data.table::fwrite(
  x = ship_data,
  file = here::here(ship_data_export_fn)
)
...
```{r message=FALSE}
utils_path <- here::here("utilities")
